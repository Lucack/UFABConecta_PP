...
Esta Política de Privacidade explica como coletamos, usamos e protegemos as informações pessoais dos usuários do aplicativo. Ao utilizar o aplicativo, você concorda com os termos descritos nesta política. Caso não concorde com estes termos, recomendamos que você não utilize o aplicativo.

Nosso aplicativo tem como objetivo reunir informações úteis para estudantes universitários, como serviços de restaurante universitário, consulta de aulas, cronogramas e contatos, facilitando o dia a dia acadêmico. Ressaltamos que algumas informações exibidas podem não estar atualizadas ou ser imprecisas, pois o aplicativo reúne dados de diversas fontes.
...
Esse aplicativo pode conter certas informações históricas a fim de facilitar a vida dos usuários. As informações históricas podem não ser atuais e são fornecidas apenas para sua referência. Reservamos o direito de modificar o conteúdo desse aplicativo a qualquer momento, procurando sempre deixar as informaçoes atualizadas no nosso aplicativo. Você concorda que é de sua responsabilidade monitorar alterações no nosso aplicativo.
...
## SEÇÃO 6 - FERRAMENTAS OPCIONAIS, ADICIONAIS
...
## SEÇÃO 9 - COLETA E USO DE INFORMAÇÕES PESSOAIS

### 9.1 Informações fornecidas pelo usuário
O aplicativo oferece a opção de login através do Google. Se você optar por fazer login, coletaremos as seguintes informações:
  - Nome
  - Endereço de e-mail
  - Foto de perfil
  - RA (Registro Acadêmico), caso você opte por fornecê-lo
  
  É importante ressaltar que o fornecimento dessas informações é opcional. O aplicativo funciona sem necessidade de login, mas algumas funcionalidades personalizadas podem não estar disponíveis sem ele.

### 9.2 Uso das informações
As informações coletadas são utilizadas exclusivamente para:
- Personalizar a experiência do usuário no aplicativo
- Exibir informações relevantes, como cronogramas de aulas e outras informações acadêmicas

### 9.3 Compartilhamento de informações
Não compartilhamos suas informações pessoais com terceiros.

### 9.4 Segurança das informações
Seguimos as boas praticas de segurança para deixar os dados na nuvem através do Google Firebase. 

## 10. FUNCIONALIDADES DO APLICATIVO

O aplicativo oferece diversas funcionalidades, incluindo, mas não se limitando a:
- Informações sobre o restaurante universitário
- Consulta de aulas
- Cronogramas acadêmicos
- Informações de contato da universidade

É importante notar que as informações exibidas no aplicativo são coletadas de diversas fontes e podem, ocasionalmente, não estar atualizadas ou conter imprecisões. Recomendamos sempre verificar informações críticas diretamente com a administração da universidade.
...
## SEÇÃO 15 - ALTERAÇÕES DOS TERMOS DE SERVIÇO
...
## SEÇÃO 17 - INFORMAÇÕES DE CONTATO

As perguntas sobre os Termos de uso e política de privacidade devem ser enviadas para nós através do lucak260@gmail.com
